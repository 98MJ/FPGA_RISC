...
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { led_reg0[0]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { led_reg0[1]  }]; #IO_L6P_T0_34                 ,Sch=LED9
set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { led_reg0[2] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { led_reg0[3] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
set_property -dict { PACKAGE_PIN P3   IOSTANDARD LVCMOS33 } [get_ports { led_reg1[0] }]; #IO_L12N_T1_MRCC_35           ,Sch=LED12
set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports { led_reg1[1] }]; #IO_L12P_T1_MRCC_35           ,Sch=LED13
set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { led_reg1[2] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { led_reg1[3] }]; #IO_L6N_T0_VREF_35            ,Sch=LED15


##7 segment display

set_property -dict { PACKAGE_PIN W7  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[0] }]; #IO_L13P_T2_MRCC_34 ,Sch=CA
set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[1] }]; #IO_L13N_T2_MRCC_34 ,Sch=CB
set_property -dict { PACKAGE_PIN U8  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[2] }]; #IO_L14P_T2_SRCC_34 ,Sch=CC
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[3] }]; #IO_L14N_T2_SRCC_34 ,Sch=CD
set_property -dict { PACKAGE_PIN U5  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[4] }]; #IO_L16P_T2_34      ,Sch=CE
set_property -dict { PACKAGE_PIN V5  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[5] }]; #IO_L16N_T2_34      ,Sch=CF
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[6] }]; #IO_L19P_T3_34      ,Sch=CG
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS33 } [get_ports { fndFont_reg3[7] }]; #IO_L19N_T3_VREF_34 ,Sch=DP

set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { fndCom_reg2[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=DP
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { fndCom_reg2[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=DP
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { fndCom_reg2[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=DP
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { fndCom_reg2[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=DP
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[8] }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[9] }]; #IO_L5N_T0_AD13N_35    ,Sch=JA2
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[10] }]; #IO_L2N_T0_AD12N_35    ,Sch=JA3
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[11] }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[12] }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[13] }]; #IO_L5P_T0_AD13P_35    ,Sch=JA8
set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[14] }]; #IO_L2P_T0_AD12P_35    ,Sch=JA9
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { led_tri_io[15] }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
