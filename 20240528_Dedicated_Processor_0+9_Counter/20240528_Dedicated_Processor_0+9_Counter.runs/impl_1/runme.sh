...
HD_PWD='D:/FPGA_RISC/20240528_Dedicated_Processor_0+9_Counter/20240528_Dedicated_Processor_0+9_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Dedicated_Process.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Dedicated_Process.tcl -notrace
