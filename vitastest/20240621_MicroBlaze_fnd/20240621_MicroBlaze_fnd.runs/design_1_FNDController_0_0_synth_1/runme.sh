...
HD_PWD='D:/FPGA_RISC/vitastest/20240621_MicroBlaze_fnd/20240621_MicroBlaze_fnd.runs/design_1_FNDController_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FNDController_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FNDController_0_0.tcl
