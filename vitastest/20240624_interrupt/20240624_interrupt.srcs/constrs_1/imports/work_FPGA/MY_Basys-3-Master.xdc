...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { sw_tri_io[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { sw_tri_io[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { sw_tri_io[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { sw_tri_io[3]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
...
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { inBtn }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
