...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x40ba60)) ;
...
extern "C" {
	...
	extern void subprog_m_f66af8f_556ead11_2240(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 1004720, 168, 333160) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_f66af8f_556ead11_2240), IP) ;
