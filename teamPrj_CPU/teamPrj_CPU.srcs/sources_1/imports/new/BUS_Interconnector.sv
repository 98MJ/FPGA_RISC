...
module DECODER (
    ...
    always_comb begin : decoder
        case (x[31:8])
            24'h0000_10: y = 10'b00_0000_0001;  //RAM
            24'h0000_20: y = 10'b00_0000_0010;  //GPI
            24'h0000_21: y = 10'b00_0000_0100;  //GPO
            24'h0000_22: y = 10'b00_0000_1000;  //GPIOA
            24'h0000_23: y = 10'b00_0001_0000;  //GPIOB
            24'h0000_24: y = 10'b00_0010_0000;  //GPIOC
            24'h0000_25: y = 10'b00_0100_0000;  //GPIOD
            24'h0000_30: y = 10'b00_1000_0000;  //FND IP
            24'h0000_40: y = 10'b01_0000_0000;  //UART IP
            24'h0000_50: y = 10'b10_0000_0000;  //Button IP
            default: y = 10'd0;
        endcase
    end
endmodule
