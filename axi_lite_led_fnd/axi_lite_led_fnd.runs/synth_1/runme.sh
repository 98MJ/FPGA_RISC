...
HD_PWD='D:/FPGA_RISC/axi_lite_led_fnd/axi_lite_led_fnd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_lite_test_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4_lite_test_ip_v1_0.tcl
